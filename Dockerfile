...
RUN apt-get update \
    && apt-get install -y --no-install-recommends locales systemd systemd-sysv sudo python3-apt python3-pip python3-setuptools iproute2 net-tools wget ca-certificates \
